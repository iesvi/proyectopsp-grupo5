...
--
-- Servidor: localhost
-- Tiempo de generación: 26-02-2020 a las 09:23:08
...
-- Base de datos: `bd1`
--
CREATE DATABASE `bd1` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `bd1`;
...
CREATE TABLE IF NOT EXISTS `encuestas` (
  ...
  `NumHermanos` int(11) NOT NULL,
  `Edad` varchar(30) NOT NULL,
  `Sexo` varchar(30) NOT NULL,
  `practicaDeporte` varchar(30) NOT NULL,
  `Deporte` varchar(30) NOT NULL,
  `Compras` int(11) NOT NULL,
  `Televisión` int(11) NOT NULL,
...
INSERT INTO `encuestas` (`Código`, `Profesión`, `NumHermanos`, `Edad`, `Sexo`, `practicaDeporte`, `Deporte`, `Compras`, `Televisión`, `Cine`) VALUES
(43, 'b', 0, 'Entre 18 y 30', 'M', 'true', 'null', 4, 5, 6),
(44, 'a', 0, 'Entre 18 y 30', 'M', 'true', 'Fútbol', 4, 4, 5),
(45, 'elEsteMolaMas', 1, 'Entre 51 y 65', 'M', 'true', 'Fútbol', 4, 5, 5),
(46, 'elEsteMolaMas', 1, 'Entre 51 y 65', 'M', 'true', 'Fútbol', 4, 5, 5),
(47, 'elOesteMolaMas1', 1, 'Entre 18 y 30', 'M', 'true', 'Atletismo', 4, 6, 6),
(48, 'a', 0, 'Entre 18 y 30', 'M', 'true', 'null', 5, 5, 5),
(49, 'b', 0, 'Entre 18 y 30', 'M', 'true', 'null', 5, 5, 5),
(50, 'tyds', 1, 'Entre 18 y 30', 'M', 'true', 'Fútbol', 1, 10, 1),
(51, 'd', 2, 'Entre 51 y 65', 'M', 'true', 'null', 5, 5, 5),
(52, 'ali g', 1, 'Entre 18 y 30', 'H', 'true', 'Fútbol', 5, 5, 5),
(53, 'a', 1, 'Entre 18 y 30', 'H', 'false', 'null', 5, 5, 5),
(54, 'asdas', 1, 'Entre 18 y 30', 'H', 'true', 'Atletismo', 5, 5, 5),
(55, 'bb', 1, 'Entre 18 y 30', 'M', 'false', 'null', 1, 6, 1),
(56, 'aa', 0, 'Entre 18 y 30', 'H', 'true', 'Fútbol', 4, 2, 6),
(57, 'a', 1, 'Entre 18 y 30', 'H', 'true', 'Fútbol', 5, 5, 5),
(58, 'bhjhbj', 1, 'Entre 18 y 30', 'H', 'false', 'null', 5, 5, 5),
(59, 'xcd', 1, 'Entre 18 y 30', 'H', 'true', 'Fútbol', 5, 5, 5),
(60, 'xcdffd', 1, 'Entre 18 y 30', 'H', 'true', 'Fútbol', 5, 5, 5),
(61, 'xcdffdr', 1, 'Entre 18 y 30', 'H', 'true', 'Fútbol', 5, 5, 5);
--
-- Base de datos: `cafes`
--
CREATE DATABASE `cafes` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `cafes`;
...
CREATE TABLE IF NOT EXISTS `cafes` (
  `CAFE_NOMBRE` varchar(32) DEFAULT NULL,
...
INSERT INTO `cafes` (`CAFE_NOMBRE`, `PROV_ID`, `PRECIO`, `VENTAS`, `TOTAL`) VALUES
('Colombia', 101, 7.99, 0, 0),
('Brasil_Torrefacto', 49, 8.99, 0, 0),
('Espresso', 150, 9.99, 0, 0),
('Colombia_Descaf', 101, 8.99, 0, 0),
('Brasil_Torrefacto_Descaf', 49, 9.99, 0, 0),
('jeff', 231, 3, 0, 0),
('JEFFV2', 1234, 5.9, 2, 1);
--
-- Base de datos: `contactos`
--
CREATE DATABASE `contactos` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `contactos`;
...
INSERT INTO `agenda` (`id`, `firstName`, `lastName`, `street`, `postalCode`, `city`, `birthday`) VALUES
(12, 'Victor', 'Lopez', 'some street', 1234, 'some city', '1999-02-21');
--
-- Base de datos: `conversor`
--
CREATE DATABASE `conversor` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `conversor`;
...
INSERT INTO `monedas` (`codigo_14`, `nombre`, `multiplicador`) VALUES
(1, 'Yen', 1),
(2, 'Lira', 0.5),
(5, 'dolar', 1.15),
(6, 'prueba', 1.82);
...
INSERT INTO `clientes` (`DNI`, `Nombre`, `Apellidos`, `Direccion`, `Localidad`, `Provincia`) VALUES
(1, 'Victor', 'Prueba', 'Joao Nº33', 'Portimao', 'Olhao'),
(6, 'afegf', 'ggr', 'rgreg', 'grdgragr', 'grgr'),
(12, 'a', 'b', 'c', 'd', 'e'),
(23, 'a', 'b', 'cDe', 'e', 'g');
...
INSERT INTO `reservas` (`ID`, `DNI`, `fEntrada`, `fSalida`, `numHab`, `tipoHab`, `fumador`, `regimen`) VALUES
(1, 1, '2020-01-22', '2020-02-12', 1, 'Doble', 'SI', 'Pensión completa'),
(2, 1, '2020-01-23', '2020-03-03', 3, 'Suite', 'SI', 'Media pensión'),
(3, 1, '2020-01-29', '2020-01-29', 0, 'Doble', 'NO', 'Alojamiento y desayuno'),
(4, 1, '2020-02-01', '2020-02-08', 1, 'Doble', 'SI', 'Alojamiento y desayuno');
--
...
('def', 'bd1', 'encuestas', 'Código', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'bd1', 'encuestas', 'Profesión', 2, NULL, 'NO', 'varchar', 30, 30, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(30)', '', '', 'select,insert,update,references', ''),
('def', 'bd1', 'encuestas', 'NumHermanos', 3, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
('def', 'bd1', 'encuestas', 'Edad', 4, NULL, 'NO', 'varchar', 30, 30, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(30)', '', '', 'select,insert,update,references', ''),
('def', 'bd1', 'encuestas', 'Sexo', 5, NULL, 'NO', 'varchar', 30, 30, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(30)', '', '', 'select,insert,update,references', ''),
('def', 'bd1', 'encuestas', 'practicaDeporte', 6, NULL, 'NO', 'varchar', 30, 30, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(30)', '', '', 'select,insert,update,references', ''),
('def', 'bd1', 'encuestas', 'Deporte', 7, NULL, 'NO', 'varchar', 30, 30, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(30)', '', '', 'select,insert,update,references', ''),
('def', 'bd1', 'encuestas', 'Compras', 8, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
('def', 'bd1', 'encuestas', 'Televisión', 9, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
('def', 'bd1', 'encuestas', 'Cine', 10, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
('def', 'cafes', 'cafes', 'CAFE_NOMBRE', 1, NULL, 'YES', 'varchar', 32, 32, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(32)', '', '', 'select,insert,update,references', ''),
('def', 'cafes', 'cafes', 'PROV_ID', 2, NULL, 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
('def', 'cafes', 'cafes', 'PRECIO', 3, NULL, 'YES', 'float', NULL, NULL, 12, NULL, NULL, NULL, 'float', '', '', 'select,insert,update,references', ''),
('def', 'cafes', 'cafes', 'VENTAS', 4, NULL, 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
('def', 'cafes', 'cafes', 'TOTAL', 5, NULL, 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
('def', 'contactos', 'agenda', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'contactos', 'agenda', 'firstName', 2, NULL, 'NO', 'varchar', 30, 30, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(30)', '', '', 'select,insert,update,references', ''),
('def', 'contactos', 'agenda', 'lastName', 3, NULL, 'NO', 'varchar', 30, 30, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(30)', '', '', 'select,insert,update,references', ''),
('def', 'contactos', 'agenda', 'street', 4, NULL, 'NO', 'varchar', 30, 30, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(30)', '', '', 'select,insert,update,references', ''),
('def', 'contactos', 'agenda', 'postalCode', 5, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
('def', 'contactos', 'agenda', 'city', 6, NULL, 'NO', 'varchar', 30, 30, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(30)', '', '', 'select,insert,update,references', ''),
('def', 'contactos', 'agenda', 'birthday', 7, NULL, 'NO', 'date', NULL, NULL, NULL, NULL, NULL, NULL, 'date', '', '', 'select,insert,update,references', ''),
('def', 'conversor', 'monedas', 'codigo_14', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'conversor', 'monedas', 'nombre', 2, NULL, 'NO', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_spanish_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
('def', 'conversor', 'monedas', 'multiplicador', 3, NULL, 'NO', 'float', NULL, NULL, 12, NULL, NULL, NULL, 'float', '', '', 'select,insert,update,references', ''),
('def', 'hotel', 'clientes', 'DNI', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', '', 'select,insert,update,references', ''),
('def', 'hotel', 'clientes', 'Nombre', 2, NULL, 'NO', 'varchar', 30, 30, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(30)', '', '', 'select,insert,update,references', ''),
('def', 'hotel', 'clientes', 'Apellidos', 3, NULL, 'NO', 'varchar', 30, 30, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(30)', '', '', 'select,insert,update,references', ''),
('def', 'hotel', 'clientes', 'Direccion', 4, NULL, 'NO', 'varchar', 30, 30, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(30)', '', '', 'select,insert,update,references', ''),
('def', 'hotel', 'clientes', 'Localidad', 5, NULL, 'NO', 'varchar', 30, 30, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(30)', '', '', 'select,insert,update,references', ''),
('def', 'hotel', 'clientes', 'Provincia', 6, NULL, 'NO', 'varchar', 30, 30, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(30)', '', '', 'select,insert,update,references', ''),
('def', 'hotel', 'reservas', 'ID', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'hotel', 'reservas', 'DNI', 2, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
('def', 'hotel', 'reservas', 'fEntrada', 3, NULL, 'NO', 'date', NULL, NULL, NULL, NULL, NULL, NULL, 'date', '', '', 'select,insert,update,references', ''),
('def', 'hotel', 'reservas', 'fSalida', 4, NULL, 'NO', 'date', NULL, NULL, NULL, NULL, NULL, NULL, 'date', '', '', 'select,insert,update,references', ''),
('def', 'hotel', 'reservas', 'numHab', 5, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
('def', 'hotel', 'reservas', 'tipoHab', 6, NULL, 'NO', 'varchar', 30, 30, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(30)', '', '', 'select,insert,update,references', ''),
('def', 'hotel', 'reservas', 'fumador', 7, NULL, 'NO', 'varchar', 3, 3, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(3)', '', '', 'select,insert,update,references', ''),
('def', 'hotel', 'reservas', 'regimen', 8, NULL, 'NO', 'varchar', 30, 30, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(30)', '', '', 'select,insert,update,references', ''),
...
('def', 'pokeapi', 'localidades', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', '', 'select,insert,update,references', ''),
('def', 'pokeapi', 'localidades', 'nombre', 2, NULL, 'YES', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
('def', 'pokeapi', 'pokemon', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', '', 'select,insert,update,references', ''),
('def', 'pokeapi', 'pokemon', 'nombre', 2, NULL, 'YES', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
('def', 'pokeapi', 'usuarios', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', '', 'select,insert,update,references', ''),
('def', 'pokeapi', 'usuarios', 'nombre', 2, NULL, 'YES', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
('def', 'pokeapi', 'usuarios', 'pswd', 3, NULL, 'YES', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
('def', 'pruebas', 'tablaprueba', 'Codigo', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'videoclub', 'peliculas', 'nombre', 1, NULL, 'NO', 'varchar', 30, 30, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(30)', 'PRI', '', 'select,insert,update,references', ''),
('def', 'videoclub', 'peliculas', 'director', 2, NULL, 'NO', 'varchar', 30, 30, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(30)', '', '', 'select,insert,update,references', ''),
('def', 'videoclub', 'peliculas', 'reparto', 3, NULL, 'NO', 'varchar', 30, 30, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(30)', '', '', 'select,insert,update,references', ''),
('def', 'videoclub', 'peliculas', 'enlace', 4, NULL, 'NO', 'varchar', 70, 70, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(70)', '', '', 'select,insert,update,references', ''),
('def', 'videoclub', 'usuarios', 'nombre', 1, NULL, 'NO', 'varchar', 30, 30, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(30)', 'PRI', '', 'select,insert,update,references', ''),
('def', 'videoclub', 'usuarios', 'password', 2, NULL, 'NO', 'varchar', 30, 30, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(30)', '', '', 'select,insert,update,references', ''),
('def', 'videoclub', 'visitas', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(100)', 'PRI', '', 'select,insert,update,references', ''),
('def', 'videoclub', 'visitas', 'iniciosesion', 2, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(100)', '', '', 'select,insert,update,references', '');
...
('BYTES_RECEIVED', '51874'),
('BYTES_SENT', '438119'),
('COM_ADMIN_COMMANDS', '29'),
...
('COM_SHOW_TABLE_STATUS', '51'),
('COM_SHOW_TABLES', '24'),
('COM_SHOW_TRIGGERS', '14'),
('COM_SHOW_VARIABLES', '58'),
('COM_SHOW_WARNINGS', '1'),
('COM_SLAVE_START', '0'),
('COM_SLAVE_STOP', '0'),
('COM_STMT_CLOSE', '0'),
...
('HANDLER_READ_PREV', '0'),
('HANDLER_READ_RND', '9'),
('HANDLER_READ_RND_NEXT', '5937'),
('HANDLER_ROLLBACK', '1'),
('HANDLER_SAVEPOINT', '0'),
('HANDLER_SAVEPOINT_ROLLBACK', '0'),
('HANDLER_UPDATE', '1'),
('HANDLER_WRITE', '5530'),
('INNODB_BUFFER_POOL_PAGES_DATA', '286'),
('INNODB_BUFFER_POOL_PAGES_DIRTY', '0'),
('INNODB_BUFFER_POOL_PAGES_FLUSHED', '176'),
('INNODB_BUFFER_POOL_PAGES_FREE', '7905'),
('INNODB_BUFFER_POOL_PAGES_MISC', '1'),
('INNODB_BUFFER_POOL_PAGES_TOTAL', '8192'),
('INNODB_BUFFER_POOL_READ_AHEAD_RND', '0'),
('INNODB_BUFFER_POOL_READ_AHEAD', '0'),
('INNODB_BUFFER_POOL_READ_AHEAD_EVICTED', '0'),
('INNODB_BUFFER_POOL_READ_REQUESTS', '3108'),
('INNODB_BUFFER_POOL_READS', '283'),
('INNODB_BUFFER_POOL_WAIT_FREE', '0'),
('INNODB_BUFFER_POOL_WRITE_REQUESTS', '285'),
('INNODB_DATA_FSYNCS', '51'),
('INNODB_DATA_PENDING_FSYNCS', '0'),
('INNODB_DATA_PENDING_READS', '0'),
('INNODB_DATA_PENDING_WRITES', '0'),
('INNODB_DATA_READ', '6819840'),
('INNODB_DATA_READS', '294'),
('INNODB_DATA_WRITES', '126'),
('INNODB_DATA_WRITTEN', '2911744'),
('INNODB_DBLWR_PAGES_WRITTEN', '88'),
('INNODB_DBLWR_WRITES', '10'),
('INNODB_HAVE_ATOMIC_BUILTINS', 'ON'),
('INNODB_LOG_WAITS', '0'),
('INNODB_LOG_WRITE_REQUESTS', '30'),
('INNODB_LOG_WRITES', '17'),
('INNODB_OS_LOG_FSYNCS', '27'),
('INNODB_OS_LOG_PENDING_FSYNCS', '0'),
('INNODB_OS_LOG_PENDING_WRITES', '0'),
('INNODB_OS_LOG_WRITTEN', '23040'),
('INNODB_PAGE_SIZE', '16384'),
('INNODB_PAGES_CREATED', '4'),
('INNODB_PAGES_READ', '282'),
('INNODB_PAGES_WRITTEN', '88'),
...
('THREADS_RUNNING', '1'),
('UPTIME', '76196'),
('UPTIME_SINCE_FLUSH_STATUS', '76196');
...
('PID_FILE', 'c:\\wamp\\bin\\mysql\\mysql5.5.24\\data\\DESKTOP-MGTKPP2.pid'),
('KEY_CACHE_DIVISION_LIMIT', '100'),
('COLLATION_SERVER', 'latin1_swedish_ci'),
('GENERAL_LOG_FILE', 'c:\\wamp\\bin\\mysql\\mysql5.5.24\\data\\DESKTOP-MGTKPP2.log'),
('FLUSH_TIME', '1800'),
...
('SLOW_QUERY_LOG_FILE', 'c:\\wamp\\bin\\mysql\\mysql5.5.24\\data\\DESKTOP-MGTKPP2-slow.log'),
...
('def', 'bd1', 'PRIMARY', 'def', 'bd1', 'encuestas', 'Código', 1, NULL, NULL, NULL, NULL),
('def', 'contactos', 'PRIMARY', 'def', 'contactos', 'agenda', 'id', 1, NULL, NULL, NULL, NULL),
('def', 'conversor', 'PRIMARY', 'def', 'conversor', 'monedas', 'codigo_14', 1, NULL, NULL, NULL, NULL),
('def', 'hotel', 'PRIMARY', 'def', 'hotel', 'clientes', 'DNI', 1, NULL, NULL, NULL, NULL),
('def', 'hotel', 'PRIMARY', 'def', 'hotel', 'reservas', 'ID', 1, NULL, NULL, NULL, NULL),
...
('def', 'pokeapi', 'PRIMARY', 'def', 'pokeapi', 'localidades', 'id', 1, NULL, NULL, NULL, NULL),
('def', 'pokeapi', 'PRIMARY', 'def', 'pokeapi', 'pokemon', 'id', 1, NULL, NULL, NULL, NULL),
('def', 'pokeapi', 'PRIMARY', 'def', 'pokeapi', 'usuarios', 'id', 1, NULL, NULL, NULL, NULL),
('def', 'pruebas', 'PRIMARY', 'def', 'pruebas', 'tablaprueba', 'Codigo', 1, NULL, NULL, NULL, NULL),
('def', 'videoclub', 'PRIMARY', 'def', 'videoclub', 'peliculas', 'nombre', 1, NULL, NULL, NULL, NULL),
('def', 'videoclub', 'PRIMARY', 'def', 'videoclub', 'usuarios', 'nombre', 1, NULL, NULL, NULL, NULL),
('def', 'videoclub', 'PRIMARY', 'def', 'videoclub', 'visitas', 'id', 1, NULL, NULL, NULL, NULL);
...
('def', 'information_schema', 'CHARACTER_SETS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 384, 0, 16434816, 0, 0, '2020-02-26 09:23:09', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLLATIONS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 231, 0, 16704765, 0, 0, '2020-02-26 09:23:09', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLLATION_CHARACTER_SET_APPLICABILITY', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 195, 0, 16357770, 0, 0, '2020-02-26 09:23:09', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLUMNS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2020-02-26 09:23:09', '2020-02-26 09:23:09', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLUMN_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2565, 0, 16757145, 0, 0, '2020-02-26 09:23:09', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'ENGINES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 490, 0, 16574250, 0, 0, '2020-02-26 09:23:09', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'EVENTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2020-02-26 09:23:09', '2020-02-26 09:23:09', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'FILES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2677, 0, 16758020, 0, 0, '2020-02-26 09:23:09', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'GLOBAL_STATUS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2020-02-26 09:23:09', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'GLOBAL_VARIABLES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2020-02-26 09:23:09', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'KEY_COLUMN_USAGE', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 4637, 0, 16762755, 0, 0, '2020-02-26 09:23:09', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PARAMETERS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2020-02-26 09:23:09', '2020-02-26 09:23:09', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PARTITIONS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2020-02-26 09:23:09', '2020-02-26 09:23:09', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PLUGINS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2020-02-26 09:23:09', '2020-02-26 09:23:09', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PROCESSLIST', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2020-02-26 09:23:09', '2020-02-26 09:23:09', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PROFILING', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 308, 0, 16562084, 0, 0, '2020-02-26 09:23:09', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'REFERENTIAL_CONSTRAINTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 4814, 0, 16767162, 0, 0, '2020-02-26 09:23:09', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'ROUTINES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2020-02-26 09:23:09', '2020-02-26 09:23:09', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SCHEMATA', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3464, 0, 16738048, 0, 0, '2020-02-26 09:23:09', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SCHEMA_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2179, 0, 16736899, 0, 0, '2020-02-26 09:23:09', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SESSION_STATUS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2020-02-26 09:23:09', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SESSION_VARIABLES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2020-02-26 09:23:09', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'STATISTICS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 5753, 0, 16752736, 0, 0, '2020-02-26 09:23:09', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 9450, 0, 16764300, 0, 0, '2020-02-26 09:23:09', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLESPACES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 6951, 0, 16772763, 0, 0, '2020-02-26 09:23:09', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLE_CONSTRAINTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2504, 0, 16721712, 0, 0, '2020-02-26 09:23:09', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLE_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2372, 0, 16748692, 0, 0, '2020-02-26 09:23:09', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TRIGGERS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2020-02-26 09:23:09', '2020-02-26 09:23:09', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'USER_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 1986, 0, 16726092, 0, 0, '2020-02-26 09:23:09', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'VIEWS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2020-02-26 09:23:09', '2020-02-26 09:23:09', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMP_RESET', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 25, 0, 13107200, 0, 0, '2020-02-26 09:23:09', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_TRX', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 4534, 0, 16766732, 0, 0, '2020-02-26 09:23:09', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMPMEM_RESET', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 29, 0, 15204352, 0, 0, '2020-02-26 09:23:09', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_LOCK_WAITS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 599, 0, 16749238, 0, 0, '2020-02-26 09:23:09', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMPMEM', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 29, 0, 15204352, 0, 0, '2020-02-26 09:23:09', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMP', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 25, 0, 13107200, 0, 0, '2020-02-26 09:23:09', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_LOCKS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 31244, 0, 16746784, 0, 0, '2020-02-26 09:23:09', NULL, NULL, NULL, '', '', NULL),
('def', 'bd1', 'encuestas', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 19, 862, 16384, NULL, 32768, 7340032, '2019-10-22 07:16:57', NULL, NULL, NULL, '', '', NULL),
('def', 'cafes', 'cafes', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 7, 2340, 16384, NULL, 0, 7340032, '2019-10-24 10:23:20', NULL, NULL, NULL, '', '', NULL),
('def', 'contactos', 'agenda', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 16384, 16384, NULL, 0, 7340032, '2019-11-26 09:25:19', NULL, NULL, NULL, '', '', NULL),
('def', 'conversor', 'monedas', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 4, 4096, 16384, NULL, 0, 7340032, '2019-11-19 07:27:44', NULL, NULL, NULL, '', '', NULL),
('def', 'hotel', 'clientes', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 4, 4096, 16384, NULL, 0, 7340032, '2020-01-14 08:06:57', NULL, NULL, NULL, '', '', NULL),
('def', 'hotel', 'reservas', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 4, 4096, 16384, NULL, 0, 7340032, '2020-01-14 08:14:32', NULL, NULL, NULL, '', '', NULL),
('def', 'mysql', 'columns_priv', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 227994731135631359, 4096, 0, '2012-04-19 13:45:09', '2012-04-19 12:45:10', NULL, NULL, '', '', NULL),
('def', 'mysql', 'db', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 440, 880, 123848989752688639, 5120, 0, '2012-04-19 13:45:09', '2012-04-19 12:45:10', '2012-04-19 13:45:10', NULL, '', '', NULL),
('def', 'mysql', 'event', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 2048, 0, '2012-04-19 13:45:09', '2012-04-19 12:45:10', NULL, NULL, '', '', NULL),
('def', 'mysql', 'func', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 162974011515469823, 1024, 0, '2012-04-19 13:45:09', '2012-04-19 12:45:10', NULL, NULL, '', '', NULL),
('def', 'mysql', 'general_log', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 0, 0, NULL, 0, 0, NULL, NULL, NULL, NULL, '', '', NULL),
('def', 'mysql', 'help_category', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 38, 581, 22078, 163536961468891135, 3072, 0, '2012-04-19 13:45:09', '2012-04-19 12:45:10', NULL, NULL, '', '', NULL),
('def', 'mysql', 'help_keyword', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 465, 197, 91605, 55450570411999231, 16384, 0, '2012-04-19 13:45:09', '2012-04-19 12:45:10', NULL, NULL, '', '', NULL),
('def', 'mysql', 'help_relation', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1029, 9, 9261, 2533274790395903, 19456, 0, '2012-04-19 13:45:09', '2012-04-19 12:45:10', NULL, NULL, '', '', NULL),
('def', 'mysql', 'help_topic', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 508, 875, 444876, 281474976710655, 20480, 0, '2012-04-19 13:45:09', '2012-04-19 12:45:10', NULL, NULL, '', '', NULL),
('def', 'mysql', 'host', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 110056715893866495, 2048, 0, '2012-04-19 13:45:09', '2012-04-19 12:45:10', NULL, NULL, '', '', NULL),
('def', 'mysql', 'ndb_binlog_index', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2012-04-19 13:45:09', '2012-04-19 12:45:10', NULL, NULL, '', '', NULL),
('def', 'mysql', 'plugin', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2012-04-19 13:45:09', '2012-04-19 12:45:10', NULL, NULL, '', '', NULL),
('def', 'mysql', 'proc', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 2048, 0, '2012-04-19 13:45:09', '2012-04-19 12:45:10', NULL, NULL, '', '', NULL),
('def', 'mysql', 'procs_priv', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 239253730204057599, 4096, 0, '2012-04-19 13:45:09', '2012-04-19 12:45:10', NULL, NULL, '', '', NULL),
('def', 'mysql', 'proxies_priv', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 693, 693, 195062158860484607, 5120, 0, '2012-04-19 13:45:10', '2012-04-19 12:45:10', '2012-04-19 13:45:10', NULL, '', '', NULL),
('def', 'mysql', 'servers', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 433752939111120895, 1024, 0, '2012-04-19 13:45:09', '2012-04-19 12:45:10', NULL, NULL, '', '', NULL),
('def', 'mysql', 'slow_log', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 0, 0, NULL, 0, 0, NULL, NULL, NULL, NULL, '', '', NULL),
('def', 'mysql', 'tables_priv', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 239535205180768255, 4096, 0, '2012-04-19 13:45:09', '2012-04-19 12:45:10', NULL, NULL, '', '', NULL),
('def', 'mysql', 'time_zone', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 1970324836974591, 1024, 0, '2012-04-19 13:45:09', '2012-04-19 12:45:10', NULL, NULL, '', '', NULL),
('def', 'mysql', 'time_zone_leap_second', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 3659174697238527, 1024, 0, '2012-04-19 13:45:09', '2012-04-19 12:45:10', NULL, NULL, '', '', NULL),
('def', 'mysql', 'time_zone_name', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 55450570411999231, 1024, 0, '2012-04-19 13:45:09', '2012-04-19 12:45:10', NULL, NULL, '', '', NULL),
('def', 'mysql', 'time_zone_transition', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 4785074604081151, 1024, 0, '2012-04-19 13:45:09', '2012-04-19 12:45:10', NULL, NULL, '', '', NULL),
('def', 'mysql', 'time_zone_transition_type', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 10696049115004927, 1024, 0, '2012-04-19 13:45:09', '2012-04-19 12:45:10', NULL, NULL, '', '', NULL),
('def', 'mysql', 'user', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 4, 53, 212, 281474976710655, 2048, 0, '2012-04-19 13:45:09', '2012-04-19 12:45:10', NULL, NULL, '', '', NULL),
...
('def', 'pokeapi', 'localidades', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 0, 0, '2020-02-25 13:11:21', NULL, NULL, NULL, '', '', NULL),
('def', 'pokeapi', 'pokemon', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 0, 0, '2020-02-25 13:08:10', NULL, NULL, NULL, '', '', NULL),
('def', 'pokeapi', 'usuarios', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 0, 0, '2020-02-25 13:13:39', NULL, NULL, NULL, '', '', NULL),
('def', 'pruebas', 'tablaprueba', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 0, 0, '2019-10-22 06:05:42', NULL, NULL, NULL, '', '', NULL),
('def', 'videoclub', 'peliculas', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 112, 112, 281474976710655, 2048, 0, '2020-02-14 09:38:01', '2020-02-14 09:38:01', NULL, NULL, '', '', NULL),
('def', 'videoclub', 'usuarios', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 3, 20, 60, 281474976710655, 2048, 0, '2020-02-14 09:38:01', '2020-02-19 09:26:51', NULL, NULL, '', '', NULL),
('def', 'videoclub', 'visitas', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 16384, 16384, NULL, 0, 0, '2020-02-25 12:17:18', NULL, NULL, NULL, '', '', NULL);
...
(91, 'root', 'localhost:58936', 'hotel', 'Query', 0, 'executing', 'SELECT * FROM `information_schema`.`PROCESSLIST`');
...
('def', 'bd1', 'latin1', 'latin1_swedish_ci', NULL),
('def', 'cafes', 'latin1', 'latin1_swedish_ci', NULL),
('def', 'contactos', 'latin1', 'latin1_swedish_ci', NULL),
('def', 'conversor', 'latin1', 'latin1_swedish_ci', NULL),
('def', 'hotel', 'latin1', 'latin1_swedish_ci', NULL),
('def', 'mysql', 'latin1', 'latin1_swedish_ci', NULL),
('def', 'performance_schema', 'utf8', 'utf8_general_ci', NULL),
('def', 'pokeapi', 'utf8', 'utf8_general_ci', NULL),
('def', 'pruebas', 'latin1', 'latin1_swedish_ci', NULL),
('def', 'test', 'latin1', 'latin1_swedish_ci', NULL),
('def', 'videoclub', 'latin1', 'latin1_swedish_ci', NULL);
...
('COMPRESSION', 'OFF'),
('CONNECTIONS', '92'),
('CREATED_TMP_DISK_TABLES', '114'),
('CREATED_TMP_FILES', '7'),
('CREATED_TMP_TABLES', '361'),
('DELAYED_ERRORS', '0'),
('DELAYED_INSERT_THREADS', '0'),
('DELAYED_WRITES', '0'),
('FLUSH_COMMANDS', '1'),
...
('HANDLER_UPDATE', '0'),
('HANDLER_WRITE', '2362'),
('INNODB_BUFFER_POOL_PAGES_DATA', '287'),
('INNODB_BUFFER_POOL_PAGES_DIRTY', '0'),
('INNODB_BUFFER_POOL_PAGES_FLUSHED', '176'),
('INNODB_BUFFER_POOL_PAGES_FREE', '7904'),
('INNODB_BUFFER_POOL_PAGES_MISC', '1'),
('INNODB_BUFFER_POOL_PAGES_TOTAL', '8192'),
('INNODB_BUFFER_POOL_READ_AHEAD_RND', '0'),
('INNODB_BUFFER_POOL_READ_AHEAD', '0'),
('INNODB_BUFFER_POOL_READ_AHEAD_EVICTED', '0'),
('INNODB_BUFFER_POOL_READ_REQUESTS', '3403'),
...
('INNODB_DATA_PENDING_READS', '0'),
('INNODB_DATA_PENDING_WRITES', '0'),
('INNODB_DATA_READ', '6836224'),
('INNODB_DATA_READS', '295'),
('INNODB_DATA_WRITES', '126'),
('INNODB_DATA_WRITTEN', '2911744'),
('INNODB_DBLWR_PAGES_WRITTEN', '88'),
('INNODB_DBLWR_WRITES', '10'),
...
('def', 'bd1', 'encuestas', 0, 'bd1', 'PRIMARY', 1, 'Código', 'A', 19, NULL, NULL, '', 'BTREE', '', ''),
('def', 'bd1', 'encuestas', 1, 'bd1', 'Código', 1, 'Código', 'A', 19, NULL, NULL, '', 'BTREE', '', ''),
('def', 'bd1', 'encuestas', 1, 'bd1', 'Código_2', 1, 'Código', 'A', 19, NULL, NULL, '', 'BTREE', '', ''),
('def', 'contactos', 'agenda', 0, 'contactos', 'PRIMARY', 1, 'id', 'A', 1, NULL, NULL, '', 'BTREE', '', ''),
('def', 'conversor', 'monedas', 0, 'conversor', 'PRIMARY', 1, 'codigo_14', 'A', 4, NULL, NULL, '', 'BTREE', '', ''),
('def', 'hotel', 'clientes', 0, 'hotel', 'PRIMARY', 1, 'DNI', 'A', 4, NULL, NULL, '', 'BTREE', '', ''),
('def', 'hotel', 'reservas', 0, 'hotel', 'PRIMARY', 1, 'ID', 'A', 4, NULL, NULL, '', 'BTREE', '', ''),
...
('def', 'pokeapi', 'localidades', 0, 'pokeapi', 'PRIMARY', 1, 'id', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'pokeapi', 'pokemon', 0, 'pokeapi', 'PRIMARY', 1, 'id', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'pokeapi', 'usuarios', 0, 'pokeapi', 'PRIMARY', 1, 'id', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'pruebas', 'tablaprueba', 0, 'pruebas', 'PRIMARY', 1, 'Codigo', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'videoclub', 'peliculas', 0, 'videoclub', 'PRIMARY', 1, 'nombre', 'A', 1, NULL, NULL, '', 'BTREE', '', ''),
('def', 'videoclub', 'usuarios', 0, 'videoclub', 'PRIMARY', 1, 'nombre', 'A', 3, NULL, NULL, '', 'BTREE', '', ''),
('def', 'videoclub', 'visitas', 0, 'videoclub', 'PRIMARY', 1, 'id', 'A', 1, NULL, NULL, '', 'BTREE', '', '');
...
('def', 'information_schema', 'CHARACTER_SETS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 384, 0, 16434816, 0, 0, NULL, '2020-02-26 09:23:09', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=43690', ''),
('def', 'information_schema', 'COLLATIONS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 231, 0, 16704765, 0, 0, NULL, '2020-02-26 09:23:09', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=72628', ''),
('def', 'information_schema', 'COLLATION_CHARACTER_SET_APPLICABILITY', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 195, 0, 16357770, 0, 0, NULL, '2020-02-26 09:23:09', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=86037', ''),
('def', 'information_schema', 'COLUMNS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2020-02-26 09:23:09', '2020-02-26 09:23:09', NULL, 'utf8_general_ci', NULL, 'max_rows=2802', ''),
('def', 'information_schema', 'COLUMN_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2565, 0, 16757145, 0, 0, NULL, '2020-02-26 09:23:09', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=6540', ''),
('def', 'information_schema', 'ENGINES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 490, 0, 16574250, 0, 0, NULL, '2020-02-26 09:23:09', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=34239', ''),
('def', 'information_schema', 'EVENTS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2020-02-26 09:23:09', '2020-02-26 09:23:09', NULL, 'utf8_general_ci', NULL, 'max_rows=618', ''),
('def', 'information_schema', 'FILES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2677, 0, 16758020, 0, 0, NULL, '2020-02-26 09:23:09', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=6267', ''),
('def', 'information_schema', 'GLOBAL_STATUS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2020-02-26 09:23:09', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'GLOBAL_VARIABLES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2020-02-26 09:23:09', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'KEY_COLUMN_USAGE', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 4637, 0, 16762755, 0, 0, NULL, '2020-02-26 09:23:09', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=3618', ''),
('def', 'information_schema', 'PARAMETERS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2020-02-26 09:23:09', '2020-02-26 09:23:09', NULL, 'utf8_general_ci', NULL, 'max_rows=6050', ''),
('def', 'information_schema', 'PARTITIONS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2020-02-26 09:23:09', '2020-02-26 09:23:09', NULL, 'utf8_general_ci', NULL, 'max_rows=5579', ''),
('def', 'information_schema', 'PLUGINS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2020-02-26 09:23:09', '2020-02-26 09:23:09', NULL, 'utf8_general_ci', NULL, 'max_rows=11328', ''),
('def', 'information_schema', 'PROCESSLIST', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2020-02-26 09:23:09', '2020-02-26 09:23:09', NULL, 'utf8_general_ci', NULL, 'max_rows=23899', ''),
('def', 'information_schema', 'PROFILING', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 308, 0, 16562084, 0, 0, NULL, '2020-02-26 09:23:09', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=54471', ''),
('def', 'information_schema', 'REFERENTIAL_CONSTRAINTS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 4814, 0, 16767162, 0, 0, NULL, '2020-02-26 09:23:09', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=3485', ''),
('def', 'information_schema', 'ROUTINES', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2020-02-26 09:23:09', '2020-02-26 09:23:09', NULL, 'utf8_general_ci', NULL, 'max_rows=583', ''),
('def', 'information_schema', 'SCHEMATA', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3464, 0, 16738048, 0, 0, NULL, '2020-02-26 09:23:09', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=4843', ''),
('def', 'information_schema', 'SCHEMA_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2179, 0, 16736899, 0, 0, NULL, '2020-02-26 09:23:09', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=7699', ''),
('def', 'information_schema', 'SESSION_STATUS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2020-02-26 09:23:09', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'SESSION_VARIABLES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2020-02-26 09:23:09', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'STATISTICS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 5753, 0, 16752736, 0, 0, NULL, '2020-02-26 09:23:09', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=2916', ''),
('def', 'information_schema', 'TABLES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 9450, 0, 16764300, 0, 0, NULL, '2020-02-26 09:23:09', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=1775', ''),
('def', 'information_schema', 'TABLESPACES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 6951, 0, 16772763, 0, 0, NULL, '2020-02-26 09:23:09', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=2413', ''),
('def', 'information_schema', 'TABLE_CONSTRAINTS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2504, 0, 16721712, 0, 0, NULL, '2020-02-26 09:23:09', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=6700', ''),
('def', 'information_schema', 'TABLE_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2372, 0, 16748692, 0, 0, NULL, '2020-02-26 09:23:09', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=7073', ''),
('def', 'information_schema', 'TRIGGERS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2020-02-26 09:23:09', '2020-02-26 09:23:09', NULL, 'utf8_general_ci', NULL, 'max_rows=569', ''),
('def', 'information_schema', 'USER_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 1986, 0, 16726092, 0, 0, NULL, '2020-02-26 09:23:09', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=8447', ''),
('def', 'information_schema', 'VIEWS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2020-02-26 09:23:09', '2020-02-26 09:23:09', NULL, 'utf8_general_ci', NULL, 'max_rows=6935', ''),
('def', 'information_schema', 'INNODB_CMP_RESET', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 25, 0, 13107200, 0, 0, NULL, '2020-02-26 09:23:09', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=671088', ''),
('def', 'information_schema', 'INNODB_TRX', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 4534, 0, 16766732, 0, 0, NULL, '2020-02-26 09:23:09', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=3700', ''),
('def', 'information_schema', 'INNODB_CMPMEM_RESET', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 29, 0, 15204352, 0, 0, NULL, '2020-02-26 09:23:09', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=578524', ''),
('def', 'information_schema', 'INNODB_LOCK_WAITS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 599, 0, 16749238, 0, 0, NULL, '2020-02-26 09:23:09', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=28008', ''),
('def', 'information_schema', 'INNODB_CMPMEM', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 29, 0, 15204352, 0, 0, NULL, '2020-02-26 09:23:09', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=578524', ''),
('def', 'information_schema', 'INNODB_CMP', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 25, 0, 13107200, 0, 0, NULL, '2020-02-26 09:23:09', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=671088', ''),
('def', 'information_schema', 'INNODB_LOCKS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 31244, 0, 16746784, 0, 0, NULL, '2020-02-26 09:23:09', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=536', ''),
('def', 'bd1', 'encuestas', 'BASE TABLE', 'InnoDB', 10, 'Compact', 19, 862, 16384, 0, 32768, 7340032, 62, '2019-10-22 07:16:57', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'cafes', 'cafes', 'BASE TABLE', 'InnoDB', 10, 'Compact', 7, 2340, 16384, 0, 0, 7340032, NULL, '2019-10-24 10:23:20', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'contactos', 'agenda', 'BASE TABLE', 'InnoDB', 10, 'Compact', 1, 16384, 16384, 0, 0, 7340032, 13, '2019-11-26 09:25:19', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'conversor', 'monedas', 'BASE TABLE', 'InnoDB', 10, 'Compact', 4, 4096, 16384, 0, 0, 7340032, 7, '2019-11-19 07:27:44', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'hotel', 'clientes', 'BASE TABLE', 'InnoDB', 10, 'Compact', 4, 4096, 16384, 0, 0, 7340032, NULL, '2020-01-14 08:06:57', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'hotel', 'reservas', 'BASE TABLE', 'InnoDB', 10, 'Compact', 4, 4096, 16384, 0, 0, 7340032, 5, '2020-01-14 08:14:32', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'mysql', 'columns_priv', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 227994731135631359, 4096, 0, NULL, '2012-04-19 13:45:09', '2012-04-19 12:45:10', NULL, 'utf8_bin', NULL, '', 'Column privileges'),
('def', 'mysql', 'db', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 2, 440, 880, 123848989752688639, 5120, 0, NULL, '2012-04-19 13:45:09', '2012-04-19 12:45:10', '2012-04-19 13:45:10', 'utf8_bin', NULL, '', 'Database privileges'),
('def', 'mysql', 'event', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 2048, 0, NULL, '2012-04-19 13:45:09', '2012-04-19 12:45:10', NULL, 'utf8_general_ci', NULL, '', 'Events'),
('def', 'mysql', 'func', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 162974011515469823, 1024, 0, NULL, '2012-04-19 13:45:09', '2012-04-19 12:45:10', NULL, 'utf8_bin', NULL, '', 'User defined functions'),
('def', 'mysql', 'general_log', 'BASE TABLE', 'CSV', 10, 'Dynamic', 2, 0, 0, 0, 0, 0, NULL, NULL, NULL, NULL, 'utf8_general_ci', NULL, '', 'General log'),
('def', 'mysql', 'help_category', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 38, 581, 22078, 163536961468891135, 3072, 0, NULL, '2012-04-19 13:45:09', '2012-04-19 12:45:10', NULL, 'utf8_general_ci', NULL, '', 'help categories'),
('def', 'mysql', 'help_keyword', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 465, 197, 91605, 55450570411999231, 16384, 0, NULL, '2012-04-19 13:45:09', '2012-04-19 12:45:10', NULL, 'utf8_general_ci', NULL, '', 'help keywords'),
('def', 'mysql', 'help_relation', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 1029, 9, 9261, 2533274790395903, 19456, 0, NULL, '2012-04-19 13:45:09', '2012-04-19 12:45:10', NULL, 'utf8_general_ci', NULL, '', 'keyword-topic relation'),
('def', 'mysql', 'help_topic', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 508, 875, 444876, 281474976710655, 20480, 0, NULL, '2012-04-19 13:45:09', '2012-04-19 12:45:10', NULL, 'utf8_general_ci', NULL, '', 'help topics'),
('def', 'mysql', 'host', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 110056715893866495, 2048, 0, NULL, '2012-04-19 13:45:09', '2012-04-19 12:45:10', NULL, 'utf8_bin', NULL, '', 'Host privileges;  Merged with database privileges'),
('def', 'mysql', 'ndb_binlog_index', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 1024, 0, NULL, '2012-04-19 13:45:09', '2012-04-19 12:45:10', NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'mysql', 'plugin', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 1024, 0, NULL, '2012-04-19 13:45:09', '2012-04-19 12:45:10', NULL, 'utf8_general_ci', NULL, '', 'MySQL plugins'),
('def', 'mysql', 'proc', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 2048, 0, NULL, '2012-04-19 13:45:09', '2012-04-19 12:45:10', NULL, 'utf8_general_ci', NULL, '', 'Stored Procedures'),
('def', 'mysql', 'procs_priv', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 239253730204057599, 4096, 0, NULL, '2012-04-19 13:45:09', '2012-04-19 12:45:10', NULL, 'utf8_bin', NULL, '', 'Procedure privileges'),
('def', 'mysql', 'proxies_priv', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 1, 693, 693, 195062158860484607, 5120, 0, NULL, '2012-04-19 13:45:10', '2012-04-19 12:45:10', '2012-04-19 13:45:10', 'utf8_bin', NULL, '', 'User proxy privileges'),
('def', 'mysql', 'servers', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 433752939111120895, 1024, 0, NULL, '2012-04-19 13:45:09', '2012-04-19 12:45:10', NULL, 'utf8_general_ci', NULL, '', 'MySQL Foreign Servers table'),
('def', 'mysql', 'slow_log', 'BASE TABLE', 'CSV', 10, 'Dynamic', 2, 0, 0, 0, 0, 0, NULL, NULL, NULL, NULL, 'utf8_general_ci', NULL, '', 'Slow log'),
('def', 'mysql', 'tables_priv', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 239535205180768255, 4096, 0, NULL, '2012-04-19 13:45:09', '2012-04-19 12:45:10', NULL, 'utf8_bin', NULL, '', 'Table privileges'),
('def', 'mysql', 'time_zone', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 1970324836974591, 1024, 0, 1, '2012-04-19 13:45:09', '2012-04-19 12:45:10', NULL, 'utf8_general_ci', NULL, '', 'Time zones'),
('def', 'mysql', 'time_zone_leap_second', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 3659174697238527, 1024, 0, NULL, '2012-04-19 13:45:09', '2012-04-19 12:45:10', NULL, 'utf8_general_ci', NULL, '', 'Leap seconds information for time zones'),
('def', 'mysql', 'time_zone_name', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 55450570411999231, 1024, 0, NULL, '2012-04-19 13:45:09', '2012-04-19 12:45:10', NULL, 'utf8_general_ci', NULL, '', 'Time zone names'),
('def', 'mysql', 'time_zone_transition', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 4785074604081151, 1024, 0, NULL, '2012-04-19 13:45:09', '2012-04-19 12:45:10', NULL, 'utf8_general_ci', NULL, '', 'Time zone transitions'),
('def', 'mysql', 'time_zone_transition_type', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 10696049115004927, 1024, 0, NULL, '2012-04-19 13:45:09', '2012-04-19 12:45:10', NULL, 'utf8_general_ci', NULL, '', 'Time zone transition types'),
('def', 'mysql', 'user', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 4, 53, 212, 281474976710655, 2048, 0, NULL, '2012-04-19 13:45:09', '2012-04-19 12:45:10', NULL, 'utf8_bin', NULL, '', 'Users and global privileges'),
...
('def', 'pokeapi', 'localidades', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 0, 7340032, NULL, '2020-02-25 13:11:21', NULL, NULL, 'utf8_general_ci', NULL, '', ''),
('def', 'pokeapi', 'pokemon', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 0, 7340032, NULL, '2020-02-25 13:08:10', NULL, NULL, 'utf8_general_ci', NULL, '', ''),
('def', 'pokeapi', 'usuarios', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 0, 7340032, NULL, '2020-02-25 13:13:39', NULL, NULL, 'utf8_general_ci', NULL, '', ''),
('def', 'pruebas', 'tablaprueba', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 0, 7340032, 1, '2019-10-22 06:05:42', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'videoclub', 'peliculas', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 1, 112, 112, 281474976710655, 2048, 0, NULL, '2020-02-14 09:38:01', '2020-02-14 09:38:01', NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'videoclub', 'usuarios', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 3, 20, 60, 281474976710655, 2048, 0, NULL, '2020-02-14 09:38:01', '2020-02-19 09:26:51', NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'videoclub', 'visitas', 'BASE TABLE', 'InnoDB', 10, 'Compact', 1, 16384, 16384, 0, 0, 7340032, NULL, '2020-02-25 12:17:18', NULL, NULL, 'latin1_swedish_ci', NULL, '', '');
...
('def', 'bd1', 'PRIMARY', 'bd1', 'encuestas', 'PRIMARY KEY'),
('def', 'contactos', 'PRIMARY', 'contactos', 'agenda', 'PRIMARY KEY'),
('def', 'conversor', 'PRIMARY', 'conversor', 'monedas', 'PRIMARY KEY'),
('def', 'hotel', 'PRIMARY', 'hotel', 'clientes', 'PRIMARY KEY'),
('def', 'hotel', 'PRIMARY', 'hotel', 'reservas', 'PRIMARY KEY'),
...
('def', 'pokeapi', 'PRIMARY', 'pokeapi', 'localidades', 'PRIMARY KEY'),
('def', 'pokeapi', 'PRIMARY', 'pokeapi', 'pokemon', 'PRIMARY KEY'),
('def', 'pokeapi', 'PRIMARY', 'pokeapi', 'usuarios', 'PRIMARY KEY'),
('def', 'pruebas', 'PRIMARY', 'pruebas', 'tablaprueba', 'PRIMARY KEY'),
('def', 'videoclub', 'PRIMARY', 'videoclub', 'peliculas', 'PRIMARY KEY'),
('def', 'videoclub', 'PRIMARY', 'videoclub', 'usuarios', 'PRIMARY KEY'),
('def', 'videoclub', 'PRIMARY', 'videoclub', 'visitas', 'PRIMARY KEY');
...
--
CREATE DATABASE `pokeapi` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `pokeapi`;
...
--
CREATE DATABASE `videoclub` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `videoclub`;
